...
-- Adaptive voxel filter for high-quality scan matching
TRAJECTORY_BUILDER_2D.adaptive_voxel_filter.max_length = 0.3
TRAJECTORY_BUILDER_2D.adaptive_voxel_filter.min_num_points = 250
...
-- Aggressive correlative scan matching (wider search)
...
-- Aggressive constraint search for better loop closures
...
-- High-quality scan matching (more computation for accuracy)
...
-- More scans per submap for higher quality maps
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 120
-- Stricter motion filter to use more scans
