...
class LidarCamBasePolarNode(Node):
    ...
    def timer_callback(self):
        ...
        # 🔹 ファイルが存在しない場合は作成
        for f in [detections_file, grid_file, conf_file, unknowns_file, semantic_file]:
    ...
    def publish_semantic_markers(self):
        ...
        for line in conf_lines:
            ...
            min_x, max_x = seed_i, seed_i
            min_y, max_y = seed_j, seed_j
    ...
    def camera_callback(self, msg):
        ...
        # uses native YOLO tracking (see id)
        if len(results) > 0:   
